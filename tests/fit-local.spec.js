...
test('guest FIT analysis is local from Ajustes and invalid files show an error',async({page})=>{
 let writes=0;
 ...
 await page.evaluate(()=>window.navTo('ajustes'));
 await expect(page.locator('#fitInput')).toBeVisible();
