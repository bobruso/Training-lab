...
import './food-camera.js?v=20260911food104';
import './ux-overhaul.js?v=20260911overhaul110';
import './advice-state.js?v=20260911overhaul110';
import './gym-hypertrophy.js?v=20260911overhaul110';
import './sleep-weekly.js?v=20260911overhaul110';
import './compare-pro.js?v=20260911overhaul110';
import './rpg-overhaul.js?v=20260911overhaul110';
import './training-effect.js?v=20260911overhaul110';

export const MAP_PROVIDER={tileSize:256,maxZoom:19,attribution:'© OpenStreetMap contributors',tileUrl(z,x,y){return `https://tile.openstreetmap.org/${z}/${x}/${y}.png`}};
