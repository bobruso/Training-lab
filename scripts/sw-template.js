...
const ASSETS=['./','./index.html','./app.js?v=__BUILD__','./runtime.js?v=__BUILD__','./styles.css?v=__BUILD__','./domain.js','./vendor/supabase.js','./manifest.webmanifest','./privacy.html'];
